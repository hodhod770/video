   ...
   <div class="container " style="padding: 20px" >
    <div class="row">
        <div class="col-12" style="margin: 3px">
            <center>
                <button data-bs-toggle="modal" data-bs-target="#add" class="btn primary-btn fa fa-plus ">اضافة قناة جديدة</button>
            </center>
        </div>
      ...
      <div class="card p-2 m-2" style="width: 18rem;">
        ...
        <div class="card-body">
          ...
          <a href="{{route('showChannal',['id'=>$item->uname])}}" class="btn btn-primary">فتح القناة</a>
        </div>
      </div>
      @endforeach
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form method="POST" wire:submit='AddChannel'>
                    ...
                    <div class="p-2" x-data="{ uploading: false, progress: 0 }"
                    ...
                    x-on:livewire-upload-progress="progress = $event.detail.progress">
                      ...
                      <img style="width: 50% ;height: 200px;" src="no.jpg" alt="no.jpg" srcset="">
                       ...
                       @else
                      <img style="width: 50% ;height: 200px;" src="{{$imageChanal->temporaryUrl()}}" alt="no.jpg" srcset="">

                      @endif
                      <br>
                      <label for="form-label">اختيار صورة اختياري</label>
                      <input wire:model.live='imageChanal' type="file" class="form-control" name="" id="">
